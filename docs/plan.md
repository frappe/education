...
- **Đã làm 2026-09-19:** thông báo trong ứng dụng (chuông ở menu, trang `/notifications`, đọc từng cái hoặc tất cả, cập nhật mỗi 60 giây) cho: bài mới, sắp đến hạn 24h (một lần cho mỗi người và bài), đã chấm và trả bài, yêu cầu làm lại, phiếu thu mới (học sinh); học sinh nộp bài (giáo viên). Email (bài mới, sắp đến hạn, đã trả, làm lại) do tác vụ định kỳ chạy mỗi 5 phút gửi, **gộp một email cho mỗi người** (tối đa 12 người mỗi lần, 10 thông báo mỗi email), thử lại 3 lần; học sinh tắt được từng loại. Thông báo giữ 90 ngày. Email đăng nhập, mời và phiếu thu vẫn gửi ngay và không tắt được. Chưa làm: học sinh vắng, đặt lại mật khẩu (không có mật khẩu).
