...
3. **Bài tập là danh sách câu hỏi trộn nhiều dạng** (đã chốt 2026-09-19): trắc nghiệm, điền đáp án ngắn, tự luận, speaking (link video). Mỗi câu có điểm riêng. Câu có đáp án đúng (chọn đáp án đúng, hoặc liệt kê các đáp án chấp nhận cho câu điền; bỏ qua dấu cách và chữ hoa) thì **hệ thống tự chấm khi nộp** và học sinh thấy kết quả ngay (kèm đáp án đúng). Bài chỉ có câu tự chấm thì trả điểm luôn. Câu còn lại giáo viên chấm; học sinh chỉ thấy điểm phần đó và tổng sau khi giáo viên trả bài. Điểm câu đã tự chấm bị khoá, giáo viên không sửa được (server từ chối, ô điểm bị vô hiệu); giáo viên vẫn viết được nhận xét cho câu đó.
...
5. **Chấm điểm**: điểm lưu nháp, chỉ hiện cho học sinh sau khi giáo viên bấm "Trả bài" (tránh lộ điểm dở dang). Giáo viên còn viết được nhận xét hoặc sửa lỗi cho từng câu (`question_notes`, tuỳ chọn, tối đa 2.000 ký tự/câu, học sinh chỉ thấy sau khi trả bài; không vào lịch sử điểm). Mỗi lần đổi điểm/phản hồi ghi `grade_revisions` (ai, khi nào, giá trị cũ → mới). Thang điểm 0-10, 0-100, A-F cấu hình theo tenant, ghi đè theo bài tập. Điểm tổng khoá học = trung bình theo `weight` của các bài đã trả (mặc định trọng số bằng nhau).
...
7. **Phiếu thu học phí** (đã chốt và làm 2026-09-19, đổi sang chọn buổi học cùng ngày): giáo viên **chọn các buổi học** để tính tiền: "New receipt" chọn học sinh rồi tick các buổi học sinh đã `attended` mà chưa nằm trên phiếu nào (mặc định chọn hết); hoặc "Create receipts for all" tạo nháp cho mọi học sinh có buổi chưa tính trong một tháng. Mỗi buổi chỉ nằm trên một phiếu chưa huỷ (câu lệnh SQL tự kiểm tra, hai yêu cầu cùng lúc không tính trùng); xoá nháp, xoá dòng hoặc huỷ phiếu thì buổi được trả về. Một học sinh có thể có nhiều phiếu trong một tháng. Phiếu được xếp vào tháng (múi giờ giáo viên) của buổi muộn nhất trong phiếu; số phiếu đếm trong tháng đó. Mỗi khoá một dòng = số buổi × giá (giá riêng của học sinh nếu có, không thì giá khoá; buổi giá 0 và buổi đã huỷ không tính, `absent` không tính). Giáo viên sửa được dòng, chọn khoá học từ dropdown hoặc "Other cost" (nội dung + số tiền), thêm một dòng giảm giá theo phần trăm hoặc số tiền cố định (server tự tính lại số giảm), nhận xét ("Comment"), hạn thanh toán; ô tiền hiện dấu chấm phân cách nghìn; lưu xong mới gửi được, và khi đã lưu thì bản nháp hiện số tiền cần trả cùng mã QR để kiểm tra; "Choose lessons" trên bản nháp đổi danh sách buổi, tính lại các dòng từ buổi học và giữ dòng thêm tay. Gửi phiếu = học sinh thấy trong portal + email (dev outbox trên staging), cấp số `INV-YYYYMM-0001` đếm tăng trong từng tháng ngay trong câu lệnh gửi (không trùng, không thủng), chụp tên và thông tin thanh toán của giáo viên (tên người nhận, SĐT, ngân hàng và mã 6 số của ngân hàng, số tài khoản, chủ tài khoản, lời nhắn; đều tuỳ chọn). Từ lúc gửi phiếu không sửa được (DB có trigger chặn cả sửa, đổi số, xoá). Sau đó: đánh dấu đã trả (và trả lại "chưa trả" nếu bấm nhầm), hoặc huỷ kèm lý do (chỉ giáo viên thấy lý do; số cũ không dùng lại; tháng đó tạo được phiếu mới). Nếu một buổi trên phiếu đã gửi bị đổi thành vắng hoặc bị huỷ, phiếu vẫn giữ nguyên và giáo viên thấy cảnh báo. Giáo viên **xuất phiếu thành ảnh PNG** (vẽ ngay trên trình duyệt) kèm **mã VietQR** chuyển khoản tạo từ số tiền của phiếu, tài khoản giáo viên (chọn ngân hàng trong danh sách hoặc nhập mã 6 số) và nội dung là số phiếu; phiếu đã trả thì ảnh không có mã QR. Học sinh vẫn có thể in trang phiếu. Ghi chú "không phải hóa đơn thuế" ở chân phiếu. Không làm Excel (đã chốt 2026-09-20).
...
- **Đã làm 2026-09-19 (chỉ trong ứng dụng, không gửi email thông báo để tiết kiệm tài nguyên):** chuông ở thanh trên cùng, bấm mở popover với thông báo mới nhất, đọc từng cái hoặc tất cả, số chưa đọc cập nhật mỗi 60 giây. Học sinh được báo: bài mới, sắp đến hạn 24h (một lần cho mỗi người và bài, tác vụ định kỳ chạy mỗi giờ), đã chấm và trả bài, yêu cầu làm lại, phiếu thu mới. Giáo viên được báo khi học sinh nộp bài. Thông báo giữ 90 ngày. Email chỉ còn cho đăng nhập, lời mời và phiếu thu. Chưa làm: học sinh vắng.
...
> **Đã chốt (2026-09-19): hệ thống không nhận upload file.** Tài liệu, đề bài và bài nộp đều là link https; không dùng R2, không quét virus. Nội dung dưới đây chỉ còn để tham khảo nếu sau này thêm upload.
...
| **M4 Hóa đơn và email** (2 tuần)                        | **Đã làm 2026-09-19:** phiếu thu học phí (tạo hàng loạt từ điểm danh, sửa, gửi, số liên tục, đã trả/huỷ, in PDF bằng trình duyệt, portal học sinh). **Chưa làm (chờ chọn SMTP):** email thật, queue/DLQ, XLSX, cron nháp hàng tháng. Đặc tả chi tiết hóa đơn (gồm nội dung pháp lý nếu cần) ngay đầu milestone; EmailProvider (Cloudflare Email Service) + Queue + DLQ, template email và PDF bằng plain English, tính hóa đơn tháng (chỉ buổi `attended`), số liên tục, xem trước, PDF/XLSX, gửi email kèm link an toàn, đánh dấu paid/void, cron bản nháp hóa đơn                                                                                                                                                                                                                   | Hóa đơn 100 học sinh < 5 phút; số hóa đơn không trùng/thủng khi chạy song song                    |
