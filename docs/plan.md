...
3. **Bài tập là danh sách câu hỏi trộn nhiều dạng** (đã chốt 2026-09-19): trắc nghiệm, điền đáp án ngắn, tự luận, speaking (link video). Mỗi câu có điểm riêng. Câu có đáp án đúng (chọn đáp án đúng, hoặc liệt kê các đáp án chấp nhận cho câu điền; bỏ qua dấu cách và chữ hoa) thì **hệ thống tự chấm khi nộp** và học sinh thấy kết quả ngay (kèm đáp án đúng). Bài chỉ có câu tự chấm thì trả điểm luôn. Câu còn lại giáo viên chấm; học sinh chỉ thấy điểm phần đó và tổng sau khi giáo viên trả bài. Giáo viên có thể sửa điểm cả câu đã tự chấm.
