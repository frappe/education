...
export default function FeeStructure() {
  ...
  const tableColumns: DataTableColumn<FeeStructure>[] = [
    {
      key: "class",
      label: "Class",
        ...
        if (isEditing) {
          return (
            <Input
              ...
              data-testid={`inline-input-${head.key}-${row.class}`}
            />
          );
        }
    ...
    })),
    {
      ...
      render: (_value: any, row: FeeStructure) => {
        const isEditing = editingClass === row.class;
                ...
                render: (row) => {
                    ...
                    return (
                      <div className="flex gap-1 justify-center">
                        <Button 
                          ...
                          data-testid={`button-save-inline-${row.class}`}
                        >
                        ...
                        <Button 
                          ...
                          data-testid={`button-cancel-inline-${row.class}`}
                        >
                  ...
                  return (
                    <Button 
                      ...
                      data-testid={`button-edit-${row.class}`}
                    >
